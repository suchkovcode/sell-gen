            ...
            return arguments.length
               ? ((this._forcing = 1),
                 !this._dp &&
                    this._ts &&
                    (this._start = ia(
                       zt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts)
                    )),
                  ...
                  pa(
                     {
                        ...
                        overwrite: "auto",
                        duration:
                           e.duration || Math.abs((n - (a && "time" in a ? a.time : i._time)) / i.timeScale()) || q,
   ...
   var $t = (function (E) {
      function Tween(e, r, i, n) {
         ...
         if (
            ...
            if (
               ((r = a.vars),
               (s = a.timeline = new Qt({ data: "nested", defaults: M || {} })).kill(),
            ...
            return (
               this.data.forEach(function (t) {
                  return t instanceof Context
                     ...
                     : t instanceof $t && t._targets[0] !== t.vars.onComplete && e.push(t);
               }),
               e
            );
         }),
   ...
   var Se,
      ...
      Tr = function _parseTransform(t, e) {
         ...
         return (
            ...
            (m = he(t, r.svg)),
            r.svg &&
               ((k = (!r.uncache || "0px 0px" === X) && !e && t.getAttribute("data-svg-origin")),
...
!(function (e, t) {
   ...
   var P =
      ((Observer.prototype.init = function init(e) {
         ...
         function Le(e, t) {
            return (
               ((se.event = e) && u && ~u.indexOf(e.target)) || (t && ge && "touch" !== e.pointerType) || (Y && Y(e, t))
            );
         }
         function Ne() {
         ...
         function Pe(e, t) {
            "y" !== ae && ((ve[2] += e), se._vx.update(e, !0)),
               ...
               Q && !ae && ((se.axis = ae = Math.abs(e) > Math.abs(t) ? "x" : "y"), (oe = !0)),
               o ? (ee = ee || requestAnimationFrame(Ne)) : Ne();
         }
         function Qe(e) {
            if (!Le(e, 1)) {
               ...
               (se.x = t),
                  ...
                  (o || Math.abs(se.startX - t) >= a || Math.abs(se.startY - r) >= a) &&
                     (h && (re = !0), o || (se.isDragging = !0), Pe(n, i), o || (p && p(se)));
            }
         }
         function Se(t) {
            if (!Le(t, 1)) {
   ...
   function Ga(e, t) {
      ...
      return (r = "scroll" + n) && (o = y(e, r))
         ? o() - Da(e)()[i]
         : Ca(e)
         ? (tt[r] || rt[r]) - (qe["inner" + n] || tt["client" + n] || rt["client" + n])
         : e[r] - e["offset" + n];
   }
   function Ha(e, t) {
   ...
   function zb() {
      (h && h.isPressed && !(h.startX > rt.clientWidth)) ||
         (k.cache++, (x = x || requestAnimationFrame(U)), vt || H("scrollStart"), (vt = bt()));
   }
   function Ab() {
   ...
   function Bb() {
      k.cache++,
         at ||
            ...
            (b && m === qe.innerWidth && !(Math.abs(qe.innerHeight - v) > 0.25 * qe.innerHeight)) ||
            l.restart(!0);
   }
   function Eb() {
   ...
   function $b(e, t, r, n, i, o, a, s, l, c, u, f, d) {
      ...
      if (o) {
         ...
         (p = "scroll" + n.d2),
            ...
            u && ((l = Ct(a)), u && (o.style[n.op.p] = l[n.op.p] - n.op.m - o._offset + Et));
      }
      return (
         d &&
            h &&
            ((p = Ct(h)), d.seek(f), (g = Ct(h)), (d._caScrollDist = p[n.p] - g[n.p]), (e = (e / d._caScrollDist) * f)),
         d && d.seek(b),
         d ? e : Math.round(e)
      );
   }
      ...
      U = function _updateAll() {
         if (!pt) {
            ...
            if (
               ((Dt = n < G ? -1 : 1),
               (G = n),
               r && (vt && !st && 200 < t - vt && ((vt = 0), H("scrollEnd")), (ot = w), (w = t)),
               Dt < 0)
            ) {
         ...
         ((ScrollTrigger.prototype.init = function init(_, T) {
            if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), mt)) {
               var k,
                  ...
                  $,
                  o,
                  Q = (_ = eb(Ia(_) || Ka(_) || _.nodeType ? { trigger: _ } : _, It)).onUpdate,
                  Z = _.toggleClass,
                  a = _.id,
                  ee = _.onToggle,
                  te = _.onRefresh,
               ...
               if (
                  ...
                  (c.tweenScroll = c.tweenScroll || { top: bc(be, Je), left: bc(be, je) }),
                  ...
                  ce &&
                     ...
                     "scrollBehavior" in rt.style && Ge.set(ve ? [rt, tt] : be, { scrollBehavior: "auto" }),
                     (p = Ja(ce.snapTo)
                        ? ce.snapTo
                        : "labels" === ce.snapTo
               ...
               (Se.previous = function () {
                     ...
                     if ((!at && Se.enabled) || t)
                        if (ie && e && vt) mb(ScrollTrigger, "scrollEnd", Eb);
                           ...
                           for (
                              Ja(y) && (y = y(Se)),
                                 ...
                                 Ia(v) &&
                                    ...
                                    (~v.indexOf(" ")
                                       ? (v = (Ia(y) ? y.split(" ")[0] : "") + v)
                                       : ((h = sb(v.substr(2), d)), (v = Ia(y) ? y : A + h), (m = ne))),
                                 E =
                                    Math.max(
                                       A,
                                       $b(v || (m ? "100% 0" : g), m, d, ge, Ae() + h, O, z, Se, p, we, me, g, fe)
                                    ) || -0.001,
                                 D = E - A || ((A -= 0.01) && 0.001),
                                 h = 0,
                                 S = w;
                           ...
                           if (
                              ...
                              (E += h),
                              (Se._pinPush = b),
                              C && h && (((r = {})[ge.a] = "+=" + h), x && (r[ge.p] = "-=" + Ae()), Ge.set([C, O], r)),
                              ie)
                           )
                              (r = cb(ie)),
                                 (o = ge === Je),
                              ...
                              for (n = ne.parentNode; n && n !== rt; )
                                 n._pinOffset && ((A -= n._pinOffset), (E -= n._pinOffset)), (n = n.parentNode);
                           f &&
                  ...
                  (Se.update = function (e, t, r) {
                     if (!fe || r || e) {
                        ...
                        if (
                           (t &&
                              ((M = P), (P = fe ? Ae() : u), ce && ((j = S), (S = T && !he ? T.totalProgress() : d))),
                           ...
                           if (
                              ...
                              he ||
                                 (!V || at || ht
                                    ...
                                    : ((fe || (gt && gt !== Se)) && V.render(V._dp._time - V._start),
                                      V.resetTo
                                         ? V.resetTo("totalProgress", d, T._tTime / T._tDur)
                                         : ((V.vars.totalProgress = d), V.invalidate().restart()))),
                              ie)
                           )
                              ...
                              a && !at
                                 ? (he &&
                                   ...
                                   de &&
                                      ...
                                      (Ma(Se.callbackAnimation), V ? V.progress(1) : Ma(T, !d, 1)))
                                 : he && Q && !at && Q(Se);
                        }
                        if (w) {
   ...
   function ec(e, t) {
      !0 === t
         ...
         : (e.style.touchAction = !0 === t ? "auto" : t ? "pan-" + t + (P.isTouch ? " pinch-zoom" : "") : "none"),
         e === tt && ec(rt, t);
   }
   function gc(e) {
      var t,
   ...
   function lc(e) {
      ...
      var n,
         ...
         m = 1,
         y =
            (P.isTouch && qe.visualViewport ? qe.visualViewport.scale * qe.visualViewport.width : qe.outerWidth) /
            qe.innerWidth,
         x = 0,
         w = Ja(t)
            ? function () {
            ...
            function (e, t) {
               if ((b.offset && ip(), t)) {
                  ...
                  f &&
                     ...
                     ((C && a.vars.scrollY >= o) || o - 1 <= r) && Ge.to({}, { onUpdate: op, duration: i });
               } else s.restart(!0);
            }),
         (e.onWheel = function () {
